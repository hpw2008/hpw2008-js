...
function bot_ui_ini() {
    ...
    botui.message.add({delay: 800, content: "Hi, there👋"}).then(function () {
        botui.message.add({delay: 1100, content: "这里是 小沛"}).then(function () {
            botui.message.add({delay: 1100, content: "一个有趣的博客~"}).then(function () {
                botui.action.button({
                    delay: 1600,
    ...
    var sure = function () {
        ...
        botui.message.add({delay: 1500, content: "兴趣爱好是编程"}).then(function () {
            botui.message.add({delay: 1500, content: "是计算机编程的忠实爱好者"}).then(function () {
                botui.message.add({delay: 1200, content: "将敲代码看成一种快乐"}).then(function () {
                    botui.message.add({
                        delay: 1500,
                        content: "主修 C++ 和 Python,略知 linux,偶尔也搞 HTML/Java/JavaScript/Spring"
                    }).then(function () {
                        botui.message.add({
                            delay: 1500,
                            content: "同时也十分热爱AI"
                        }).then(function () {
                            botui.message.add({delay: 1800, content: "喜欢弄电脑和玩手游"}).then(function () {
                                botui.action.button({
                                    delay: 1100,
                                    action: [{text: "为什么叫小沛呢？🤔", value: "why-mashiro"}]
                                }).then(function (a) {
                                    thirdpart()
                                })
                            })
        ...
        botui.message.add({delay: 1e3, content: "因为这是我的一个外号"}).then(function () {
            botui.action.button({delay: 1500, action: [{text: "为什么会有这个外号？", value: "why-cat"}]}).then(function (a) {
                fourthpart()
            })
        })
    }, fourthpart = function () {
        botui.message.add({delay: 1e3, content: "我先前的游戏名就是这个"}).then(function () {
            botui.message.add({delay: 1100, content: "可能希望自己打游戏很厉害吧，哈哈哈"}).then(function () {
                botui.action.button({
                    delay: 1500,
        ...
        botui.message.add({delay: 1e3, content: "emmmm,让我想想,csdn,github,都是一样的哦"}).then(function () {
